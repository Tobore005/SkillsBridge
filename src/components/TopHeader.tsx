...
export function TopHeader({ onMenuClick }: { onMenuClick?: () => void }) {
    return (
        <header className="h-24 bg-white border-b border-gray-100 flex items-center justify-between px-4 lg:px-8 text-[#1e2a5e]">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-xl lg:text-2xl font-bold tracking-tight">Welcome, Mrs. Tola!</h1>
                    <p className="text-gray-500 text-xs lg:text-sm mt-1 line-clamp-1">
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-gray-200 overflow-hidden border border-gray-200">
                        <div className="w-full h-full bg-[#1e2a5e]/10 flex items-center justify-center text-[#1e2a5e] font-bold">
                            MT
                        </div>
                    </div>
