            ...
            <div>
              <div className="space-y-1 mb-5">
                <div className="flex items-center gap-3 flex-wrap">
                  <h4 className="font-inter font-medium text-[20px] leading-[100%] tracking-[0%] text-black">
                    {id} — {title}
                  </h4>
                  <span
              ...
              {/* Status Box */}
              <div
                className={`w-full lg:w-fit min-w-[300px] p-4 rounded-xl border flex items-center justify-between gap-4 ${
                  status === "Active"
